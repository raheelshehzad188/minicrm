  ...
  <div class="col-lg-4">
    <div class="mino-card">
      <div class="mino-card-body text-center">
        <span class="mino-avatar mino-avatar-xl mx-auto mb-3"><?php echo html_escape(user_initials($user->name)); ?></span>
        ...
        <?php if (!empty($user->last_login)): ?>
          <p class="mino-text-xs mino-text-muted mt-3 mb-0">Last login: <?php echo html_escape($user->last_login); ?></p>
        <?php endif; ?>
      </div>
    </div>
  </div>
