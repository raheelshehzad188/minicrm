...
<body style="font-family:Arial,sans-serif;background:#f1f5f9;padding:24px;">
  <div style="max-width:560px;margin:0 auto;background:#fff;border-radius:12px;padding:32px;">
    <h2 style="color:#0F766E;margin-top:0;">Password reset</h2>
    <p>Hi <?php echo html_escape($name); ?>,</p>
    <p>An administrator reset your Mino CRM password.</p>
    <p><strong>Temporary password:</strong> <?php echo html_escape($password); ?></p>
    ...
    <p style="color:#64748b;font-size:13px;">Change your password after signing in.</p>
  </div>
</body>
</html>
